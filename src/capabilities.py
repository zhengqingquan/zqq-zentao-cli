...
CAPABILITIES: dict[str, frozenset[BackendName]] = {
    ...
    "todo": frozenset({"rest"}),
    "todo.write": frozenset({"rest"}),
    "testcase": frozenset({"rest"}),
    "testcase.write": frozenset({"rest"}),
    "testsuite": frozenset({"rest"}),
    "testsuite.write": frozenset({"rest"}),
    "testtask": frozenset({"rest"}),
    "testtask.write": frozenset({"rest"}),
